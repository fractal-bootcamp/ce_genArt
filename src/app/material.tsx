...
const NoiseShaderMaterial = shaderMaterial(
  ...
  // 2. Vertex Shader: Handles the position/geometry of the mesh
  // This is a basic vertex shader that just passes UV coordinates to the fragment shader
  `
...
// Extend Three.js materials with custom shader
